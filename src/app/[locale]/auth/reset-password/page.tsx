        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl overflow-hidden shadow-2xl border border-white/20">
          <div className="p-8">
            ...
            <div className="flex flex-col items-center mb-6">
              ...
              <h1 className="text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-white to-purple-200">Reset Password</h1>
              <p className="text-white/80 mt-2">We'll email you a link to reset your password</p>
            </div>
